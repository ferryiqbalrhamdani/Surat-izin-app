                            ...
                            <div class="container">
                                ...
                                @foreach ($suratIzin as $s)
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="tanggal_izin" value="{{date('m/d/Y', strtotime($s->tanggal_izin))}}" name="tanggal_izin" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" name="jam_mulai" id="jam_mulai" value="{{$s->jam_mulai}}" class="form-control">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" id="jam_akhir" name="jam_akhir" value="{{$s->jam_akhir}}" class="form-control">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="keterangan_izin" id="keterangan_izin" cols="30" rows="5" class="form-control">{{$s->keterangan_izin}}</textarea>
